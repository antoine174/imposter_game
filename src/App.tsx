...
import { Eye, EyeOff, Play, RotateCcw, Crown, AlertTriangle, Fingerprint, Smile, Sparkles, User, Key, Search } from 'lucide-react';

// --- ARABIC WORD LIST ---
const WORD_LIST = [
  'صبي رقاصه', 'اندومي', 'مصاصه', 'قصب', 'مخدرات', 
  'اختبار حمل', 'نوم', 'مصيف', 'بكيني', 'توك توك', 'شبشب', 'كوارع', 'سيجارة فرط', 'ميكروباص',
